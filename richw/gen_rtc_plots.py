...
df_rtc,df_val_bursts_subset,df_sites_subset,dir_rtc_site_data,basename_rtc_site_data = test_setup.setup(dir_base)
...
#  index,df_row = next(df_val_bursts_subset.iterrows())
  ...
  df_rtc_ts_wind = pd.read_csv(filename_rtc_site_data).drop(columns=
    ['Unnamed: 0'])
